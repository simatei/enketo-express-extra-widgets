...
RUN npm install https://github.com/simatei/enketo-image-customization-widget.git
RUN npm install https://github.com/simatei/enketo-literacy-test-widget.git
